<%--
    Document   : myContacts
    Created on : Nov 11, 2017, 11:02:30 AM
    Author     : mattias
--%>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/minitwitter-master/myContacts">My contacts</a></li>
                            ...
                            <table class="table fixed" id="tweetList">
                                <tbody id="extend">
                                    <tr data-toggle="collapse123" class="clickableRow spaceUnder" nowrap="true">
                                        ...
                                        <td align="right" class="AlignRight" style="border-left: 0px;" nowrap="true"><input id="unFollowUser" type="button" value="Unfollow" class="btn btn-sm btn-danger" onclick="location.href = '/minitwitter-master/unFollowUser/${listUsers[i].getId()}';"/></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
