<%--
    Document   : register
    Created on : Nov 9, 2017, 10:21:30 AM
    Author     : mattias
--%>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/minitwitter-master/register">Register</a></li>
        ...
        <div class="container theme-showcase" role="main">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <form id="regForm" action="/minitwitter-master/create" method="post" modelAttribute="userFormData">
                        <fieldset>
